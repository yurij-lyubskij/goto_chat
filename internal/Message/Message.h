...
class iMessage{
	...
	public:
		...
		iMessage(int _id, std::string _content, time_t _sendTime , int _senderId , int _chatId , enum MessegeType _type): id(_id), content(_content),
...
class Message: public iMessage{
	...
	public:
		...
		Message(int);
		Message(std::string, time_t, int, int);							//Creates object with id = 0 to add to database
		Message(int, std::string, time_t, int, int);
...
class VoiceMessage: public iMessage{
	...
	public:
		...
		VoiceMessage(int);
		VoiceMessage(std::string, time_t, int, int);							//Creates object with id = 0 to add to database
		VoiceMessage(int, std::string, time_t, int, int);
